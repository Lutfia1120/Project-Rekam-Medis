...
<div class="d-flex">
  ...
  <main class="main-content">
    <h2 class="mb-1">DATA TINDAKAN</h2>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex gap-1">
                    <a href="t_update.php?kd_tindakan=<?= $row['kd_tindakan'] ?>" class="btn btn-primary btn-sm">Update</a>
                    <a href="t_delete.php?kd_tindakan=<?= $row['kd_tindakan'] ?>" onclick="return confirm('Hapus Data?')" class="btn btn-danger btn-sm">Hapus</a>
                  </div>
                </td>
              </tr>
          <?php }
